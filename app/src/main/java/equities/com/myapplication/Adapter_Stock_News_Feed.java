...
public class Adapter_Stock_News_Feed extends RecyclerView.Adapter<Adapter_Stock_News_Feed.MyViewHolder> {

   private List<Constructor_Stock_News_Feed> stock_market_news_feedItems;
   private static Context context;
   public Adapter_Stock_News_Feed(Context context, List<Constructor_Stock_News_Feed> items){
     this.context=context;  
     this.stock_market_news_feedItems = items;
   }  
   ...
   public void onBindViewHolder(MyViewHolder holder, int position) {
       Constructor_Stock_News_Feed item = stock_market_news_feedItems.get(position);
   ...
   public int getItemCount() {  
     return stock_market_news_feedItems==null?0:stock_market_news_feedItems.size();
   }  
