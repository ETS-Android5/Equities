...
public class Adapter_Chosen_News_Feed extends RecyclerView.Adapter<Adapter_Chosen_News_Feed.MyViewHolder> {
   ...
   public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
     ...
     final View view = inflater.inflate(R.layout.recyclerview_news_chosen, parent, false);
